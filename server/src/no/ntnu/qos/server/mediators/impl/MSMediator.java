...
/**
 * This mediator contacts a Monitoring Service to get routing information. Sends
 * endpoint IP-address, and gets the bandwidth of the weakest link and the GUID
 * of the last Tactical Router on the path to endpoint. Sets the bandwidth and
...
public class MSMediator extends AbstractQosMediator {
    ...
    public boolean mediateImpl(MessageContext synCtx, SynapseLog synLog) {
        try {
            ...
            synCtx.setProperty(MediatorConstants.QOS_BANDWIDTH,
                    (long) (ri.getBandwidth() >= 0 ? ri.getBandwidth() * 1024 : -1));
