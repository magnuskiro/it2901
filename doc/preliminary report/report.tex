...
\section{Task Description and Requirements}\label{taskdescreq} This is the section where we describe the task and it's requirements in detail.
    \subsection{Abstract}\label{taskabst} 
...
\section{Project Methodoloogy}\label{methodology} How we organize the project, the workflow and the work methods. 
...
\section{Prestudy}\label{prestudy} The research, information gathering og technology understanding in the beginning of the project, before we finalise architecture and start implementation.
    ...
    \subsection{Alternative solutions}\label{alternativesolutions} [Sollutions that we have, thought about but discarded.]
        ...
        Since you can see an outline to the architecture in \ref{architecture} we will instead use this section to outline some of the alternative architectures which we looked at, but rejected for the moment.
