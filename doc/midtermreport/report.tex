...
\section{Project Management}\label{management} 
    ...
    %%scrum master / methodology guy / Meeting leader.
    
    
    %Specify and explain the group dynamic.
...
\section{Development Methodology}\label{methodology} 
    ...
    %elaborate the benefits an usage of individuals and interaction
    ...
    %Elaborate the scrum elements that we use and what benefits they have for us. 
    The pinch of Scrum\footnote
        {Scrum is a form of agile project management [\href{http://en.wikipedia.org/wiki/Scrum_(development)}{Wikipedia: Scrum}]}. 
    We use some elements from scrum that is 
