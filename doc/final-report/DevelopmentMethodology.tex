...
%Comment on the fact that the supervisor communication on the theme of scurm should be commented. 

%Make sure to have a clear description. <- Needs improvement. 
%compare scrum and waterfall, to see why we waterfall is better for our project. 
