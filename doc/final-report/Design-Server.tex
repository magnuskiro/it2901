...
Sampling Message Processor:\\
	...
	Below is an example setup of a service in ppd.xml \ref{xml:ppd}.

\lstset{language=XML}
\begin{lstlisting}[frame=single] \label{xml:ppd}
