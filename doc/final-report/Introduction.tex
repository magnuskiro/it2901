\section{Project Introduction}\label{Project Introduction}
    ...
    \begin{Student}
    \textit{Kirø, Magnus L.} \\
        Currently studying informatics on the third year of a bachelors degree. Expecting to take a masters degree afterwords, probably something related to Computer Science.  
        experience
        Strong points. 
        \\
    \end{Student}
