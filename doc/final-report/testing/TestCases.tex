	...
	As most of the tests below are quite similar, the reasoning behind them is also fairly similar. The main difference between them is the “Timeout”, which refer to the timeout the ESB uses. For more about the “Timeout” see \ref{Configuration of the ESB}.
