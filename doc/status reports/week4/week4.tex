...
\\To manage our source code, we will use Git via Github, where our project will be available as open source. The client has agreed to this. We will at all times maintain two branches of the source; a Master branch and a Testing branch. All development will be done against Testing. Every other week, we'll do a full test of Testing, and if it's declared healthy, it will be merged into Master as soon as possible. After the merge, Testing will again be open for development.
\\\\
...
\\The meeting, together with two reports that FFI has sent us regarding previous work done on the subject, gave us a clear idea of our task.
\\\\
...
\\Created a technical glossary for the project, which will be shared with FFI so that we have a clear definition of the technical terms and expressions
